...
<?php if ($searchTitle != '') : ?>
<p>Showing <strong><?php echo sizeof($dvds) ?></strong> results for <strong><?php echo $searchTitle ?></strong> in 
  <?php if ($searchGenre != '') : ?>
  ...
  <?php endif ?>
  <a href="/dvds/search">Back to search!</a></p>
<?php else : ?>
<p>Showing all <strong><?php echo $dvdCount ?></strong> DVDs. <a href="/dvds/search">Looking for something specific?</a></p>
<?php endif ?>
